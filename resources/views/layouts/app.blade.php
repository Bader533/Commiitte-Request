...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('front/order.css') }}" />
    @yield('css')
</head>
<!--end::Head-->
<!--begin::Body-->
                    ...
                    <div class="aside-user d-flex align-items-sm-center justify-content-center py-5">
                        ...
                        <div class="aside-user-info flex-row-fluid flex-wrap ms-5">
                            ...
                            <div class="d-flex">
                                ...
                                <!--begin::Description-->
                                <span
                                    class="text-gray-600 fw-bold d-block fs-8 mb-1">{{ App\Models\USERS_TB::auth()->JOB_TITLE }}</span>
                                <!--end::Description-->
                                <!--begin::Label-->
                                <div class="d-flex align-items-center text-success fs-9">
                                    <span
                                        class="text-gray-600 fw-bold d-block fs-8 mb-1">{{ App\Models\USERS_TB::auth()->DEPARTMENTS_NAME }}</span>
                                </div>
                                <!--end::Label-->
                            </div>
                            <!--end::Info-->
                    ...
                    <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                        ...
                        <div class="menu-item">
                            <div class="menu-content pb-2">
                                <span class="menu-section text-muted text-uppercase fs-8 ls-1">القائمة</span>
                            </div>
                        </div>
                        @foreach (session()->get('user_data')['menu'] as $key=>$value )
                        <div class="menu-item">
                            <a class="menu-link  {{ request()->is($value["URL"]) ? 'active' : '' }}"
                        ...
                        {{--
                        <div class="menu-item">
                            <a class="menu-link {{ request()->is('request_committee/agent/index') ? 'active' : '' }}"
                                href="{{ route('request_committee.agent.formrequest') }}">
                                <span class="menu-icon">
                                ...
                                <span class="menu-title">طلب لجنة</span>
                            </a>
                        </div>

                        <div class="menu-item">
                            <a class="menu-link {{ request()->is('request_committee/affairs/index') ? 'active' : '' }}"
                                href="{{ route('request_committee.affairs.index') }}">
                                <span class="menu-icon">
                                    <!--begin::Svg Icon | path: icons/duotune/communication/com001.svg-->
                                    <span class="svg-icon svg-icon-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                        ...
                        <div class="menu-item">
                            <a class="menu-link {{ request()->is('request_committee/department/index') ? 'active' : '' }}"
                                href="{{ route('request_committee.department.index') }}">
                                <span class="menu-icon">
                                    <!--begin::Svg Icon | path: icons/duotune/communication/com001.svg-->
                                    <span class="svg-icon svg-icon-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                ...
                                <span class="menu-title"> الطلبات عند ادارة معينة</span>
                            </a>
                        </div>
                         --}}
                    </div>
                ...
                <div class="toolbar">
                    ...
                    <div
                        ...
                        <div class="page-title d-flex flex-column me-5">
                            <!--begin::Title-->
                            <h1 class="d-flex flex-column text-dark fw-bolder fs-3 mb-0">{{ config('app.name') }}
                            </h1>
                            <!--end::Title-->
                            <!--begin::Breadcrumb-->
                            <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 pt-1">
                                ...
                                {{-- <li class="breadcrumb-item text-muted">
                                        <a href="../../demo8/dist/index.html"
                                            class="text-muted text-hover-primary">{{__('app.request_a_commission')}}</a>
                                    </li> --}}
                            </ul>
                            <!--end::Breadcrumb-->
                        </div>
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px"
                                            ...
                                            <div class="d-flex flex-column bgi-no-repeat rounded-top"
                                                ...
                                                <h3 class="text-white fw-bold px-9 mt-10 mb-6">
                                                    ...
                                                    <span class="fs-8 opacity-75 ps-3">24
                                                        {{ __('app.reports') }}</span>
                                                </h3>
                                                <!--end::Title-->
                                                <!--begin::Tabs-->
                                                <ul
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link text-white opacity-75 opacity-state-100 pb-4"
                                                            data-bs-toggle="tab"
                                                            href="#kt_topbar_notifications_1"></a>
                                                    </li>
                                                </ul>
                                                <!--end::Tabs-->
                                            </div>
                                            ...
                                            <div class="tab-content">
                                                ...
                                                <div class="tab-pane fade show active"
                                                    ...
                                                    <div class="scroll-y mh-325px my-5 px-8">
                                                        ...
                                                        <div class="d-flex flex-stack py-4">
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="mb-0 me-2">
                                                                    <a href="#"
                                                                        class="fs-6 text-gray-800 text-hover-primary fw-bolder">طلب
                                                                        تشكيل لجنة</a>
                                                                    <div class="text-gray-400 fs-7">بعض التفاصيل....
                                                                    </div>
                                                                </div>
                                                                <!--end::Title-->
                                                            </div>
                                                    ...
                                                    <div class="py-3 text-center border-top">
                                                        <a href="{{ route('request_committee.notification') }}"
                                                            class="btn btn-color-gray-600 btn-active-color-primary">{{ __('app.View_All') }}
