                ...
                <div class="w-lg-500px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
                    ...
                    <form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" method="POST"
                        ...
                        <div class="fv-row mb-10 ">
                            ...
                            <input class="form-control form-control-lg form-control-solid is-invalid" type="text" name="p_id"
                                autocomplete="off" />
                             @else
                             <input class="form-control form-control-lg form-control-solid " type="text" name="p_id"
                                autocomplete="off" placeholder="ادخل اسم المستخدم" />
                            @endif
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
