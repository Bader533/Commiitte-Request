...
public function change_status_req_agent($id_req,$P_STATUS_TB_ID,$P_USERS_ID)
{
    $pdo = DB::getPdo();
    $P_REQUEST_COMMITTEE_TB = $id_req;
    //  $USERS_TB_ID = 2;
    // $NAME = 'الوكيل يوافق على الطلب';
    $stmt = $pdo->prepare("begin HANI.Post_req_agent(:P_STATUS_TB_ID,:P_REQUEST_COMMITTEE_TB,:P_USERS_ID); end;");
    ...
    $stmt->bindParam(':P_USERS_ID',$P_USERS_ID, PDO::PARAM_INT);
